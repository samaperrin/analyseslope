...
slope_table <- extract_slope_params(parameters_of_interest, connectivity, con)
```
...
plot_slope_params(slope_table,c(1,1))
```
...
slope_analysed <- slope_analysis(slope_table,parameters_for_analysis)
